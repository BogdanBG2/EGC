...
void Laborator2::Init()
{
	...
	// the tetrahedron / pyramid
	{
		vector<VertexFormat> vertices2
		{
			VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1, 1, 0)),
			VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1, 0, 1)),
			VertexFormat(glm::vec3(0.5f, 1, 0.33f), glm::vec3(0, 1, 1)),
			VertexFormat(glm::vec3(0.5f, 0, 1), glm::vec3(1, 1, 1))
		};
...
void Laborator2::Update(float deltaTimeSeconds) {
	...
	RenderMesh(meshes["cube3"], shaders["VertexColor"], glm::vec3(0, 0, 0), glm::vec3(0.4f));

	RenderMesh(meshes["pyramid"], shaders["VertexColor"], glm::vec3(1, 0, 0), glm::vec3(0.6f));

	RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(0, 1.4f, 0));
